...
public class SamuraiExtended {  //extends Samurai
    private String name;
    ...
    public SamuraiExtended() {
    }

    ;

    public SamuraiExtended(String name) {
        this.name = name;
    }

    public SamuraiExtended(String name, WeaponType weaponType, boolean doubleweapon, boolean hasHorse, boolean hasArmor, Type type, double hitpower, double life) {
        this.name = name;
    ...
    public void print() {
        System.out.println("Name is " + name + " and his weapon is " + weaponType + " and has double weapon is: " + doubleweapon + " and has a horse is: " + hasHorse + " and has an armor is: " +
                hasArmor + " and he is a " + type + ". His hitpower is: " + hitpower + " and remaining life is: " + Math.ceil(life));
    }
    ...
    public void agility(double damage){
        double agility = 10.0;
        double fdamage = defend(damage);
        fdamage -= agility;
        if(fdamage <= 0) fdamage = 0;
        System.out.println(" Due to extra agility skill my defense is better and I lose less life ");
        life-=fdamage;
        checkState();
    }

//    @Override    ---> αν εκανα extends Samurai θα μπορουσα να κανω αυτο για την attack ? (δηλαδη παιρνω την λειτουργια (μεθοδο attack() απο την κλαση Samurai) + extra λειτουργια
//    public double attack(){
//      double attackBase = super.attack();
//      System.out.println("Εχtended attack!");
    //  return attackBase;
//    }
//      public double criticalHit(){
//        double extraDmg = 15.0;
//        return this.attack() + extraDmg;
//      }
}
